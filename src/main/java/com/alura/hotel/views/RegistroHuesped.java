...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuesped() {
		...
		int txtNreserva = Integer.parseInt(nReserva);
		
		Huesped nuevoHuesped = new Huesped(txtNombre.getText(), txtApellido.getText(), Date.valueOf(fechaN), 
				(String)txtNacionalidad.getSelectedItem(), txtTelefono.getText(), txtNreserva);
